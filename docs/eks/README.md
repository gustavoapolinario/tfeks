...
| <a name="provider_aws.virginia"></a> [aws.virginia](#provider\_aws.virginia) | >= 5.20 |
...
| <a name="input_karpenter_helm_chart_version"></a> [karpenter\_helm\_chart\_version](#input\_karpenter\_helm\_chart\_version) | Karpenter Helm chart version. | `string` | `"v0.31.1"` | no |
...
| <a name="output_helm_karpenter_namespace"></a> [helm\_karpenter\_namespace](#output\_helm\_karpenter\_namespace) | n/a |
| <a name="output_helm_karpenter_version"></a> [helm\_karpenter\_version](#output\_helm\_karpenter\_version) | n/a |
| <a name="output_karpenter-irsa-arn"></a> [karpenter-irsa-arn](#output\_karpenter-irsa-arn) | n/a |
